...
const storyElectric = {
  ...
  model: {
    emitter: {
      particleType: 'PROTON PROTON PROTON  ELECTRON ELECTRON ELECTRON PHOTON PHOTON PHOTON',
      bunchShape: 'SQUARE',
      direction: [0, 0, 1],
      position: [0, 1, -5],
...
const random = {
  ...
  model: {
    ...
    emitter: {
      ...
      direction: [0, 0, -1],
      particleSeparation: 0.1,
      directionJitter: [0.15, 0.15, 0],
      emitterDirectionJitter: [0.1, 0.1, 0],
      gamma: 1000,
