...
test('squareDistribution({n: 3, d: 1})', () => {
  ...
  expect(arrayToNumbers(distribution[0])).toEqual([-0.5, -0.5, 0])
  expect(arrayToNumbers(distribution[1])).toEqual([0.5, -0.5, 0])
  expect(arrayToNumbers(distribution[2])).toEqual([-0.5, 0.5, 0])
})
...
test('squareDistribution({n: 4, d: 1})', () => {
  ...
  expect(arrayToNumbers(distribution[1])).toEqual([0.5, -0.5, 0])
  expect(arrayToNumbers(distribution[2])).toEqual([-0.5, 0.5, 0])
  expect(arrayToNumbers(distribution[3])).toEqual([0.5, 0.5, 0])
})
